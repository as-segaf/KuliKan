				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="about-us.html"> Tentang Kami</a></p>
						</div>											
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="profil">
						<div class="row d-flex justify-content-center">
							<div class="col-md-10 pb-40 header-text">
								...
								<p>
									KuliKan.com mengajak para penyedia jasa yang berkualitas untuk menjadi mitra/partner Kulikan.com sehingga customer bisa mencari penyedia jasa yang cocok
								</p>
								<p>
									KuliKan.com menyediakan tempat bagi customer untuk mencari penyedia jasa berkualitas yang sudah menjadi partner KuliKan.com
								</p>
							</div>
						</div>
					</div>
					<div class="row d-flex justify-content-center">
						<div class="col-md-8 pb-40 header-text">
							...
							<p>
								Kami membantu semua pihak agar semua bisa mendapat kemudahan dalam menyelesaikan urusan
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-service">
								<h4><span class="lnr lnr-user"></span>Jasa Berkualitas</h4>
								<p>
									Kami selalu mencari penyedia jasa untuk menjadi partner yang terpercaya dan berkualitas. 
								</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="single-service">
								...
								<p>
									Kami selalu mengutamakan pelayanan yang terbaik kepada semua customer dan partner kami
								</p>								
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
